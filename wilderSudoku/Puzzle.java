 ...
 * it contains a {@link wilderSudoku.Square Square} array, methods
...
public class Puzzle implements Cloneable {
	...
	/**
	 * Returns the {@link wilderSudoku.Number Number} value of the square 
	 * @param x index value of a 9x9 array
	 * @param y index value of a 9x9 array
	 * @return the {@link wilderSudoku.Number Number} constant
	 */
	 ...
	 * @param x index value of a 9x9 array
	 * @param y index value of a 9x9 array
	 * @return a TreeSet<{@link wilderSudoku.Number Number}> if exists, null if do not exists
	 */
	...
	/**
	 * Initializes the value of a null {@link wilderSudoku.Square Square}, making the fields isLocked and isInitial true.
	 * @param x index value of a 9x9 array
	 * @param y index value of a 9x9 array
	 ...
	 */
	public void setInitialSquare(int x,int y, Number value) throws InitializationException, InvalidCoordinateException {
	 ...
	 * 
	 * @param vertNumber
	 *            the index value of the vertical unit to check
	 ...
	 * 
	 * @param HoriNumber
	 *            the index value of the horizontal unit to check
	 ...
	 * 
	 * @param vertNumber
	 *            an index value of which horizontal
	 * @param number
	 *            a {@linkplain wilderSudoku.Number Number}
	 ...
	 * 
	 * @param areaNumber
	 *            an {@linkplain wilderSudoku.Area Area}
	 * @param number
	 *            a {@linkplain wilderSudoku.Number Number}
	 * @return true if the number is there, false if the number is not there
